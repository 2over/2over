...
- 🌱 I’m currently learning **JVM、Linux OS、Assembly Language、Go、Rust、BlockChain、AI**
...
![RocketMQ](https://img.shields.io/badge/RocketMQ-D77310?style=flat&logo=apache%20rocketmq&logoColor=white)
...
| 仓库 | 简介 | Stars |
|------|------|-------|
| [XVM](https://github.com/2over/XVM) | 手写JVM | ![stars](https://img.shields.io/github/stars/2over/XVM?style=flat&label=) |
| [XVM-cpp](https://github.com/2over/XVM-cpp) | 手写JVM C++版| ![stars](https://img.shields.io/github/stars/2over/XVM-cpp?style=flat&label=) |
| [my-agent](https://github.com/2over/my-agent) | Agent / 自动化 | ![stars](https://img.shields.io/github/stars/2over/my-agent?style=flat&label=) |
...
| [my-aqs](https://github.com/2over/my-aqs) | AQS 同步队列器实现 | ![stars](https://img.shields.io/github/stars/2over/my-aqs?style=flat&label=) |
...
| 仓库 | 简介 | Stars |
|------|------|-------|
| [my-go-server](https://github.com/2over/my-go-server) | Go Web 服务 | ![stars](https://img.shields.io/github/stars/2over/my-go-server?style=flat&label=) |

### 🐧 Linux OS

| 仓库 | 简介 | Stars |
|------|------|-------|
| [my-multicore-x64](https://github.com/2over/my-multicore-x64) | x64 多核引导 / 内核 | ![stars](https://img.shields.io/github/stars/2over/my-multicore-x64?style=flat&label=) |
| [my-x86-os](https://github.com/2over/my-x86-os) | x86 操作系统 | ![stars](https://img.shields.io/github/stars/2over/my-x86-os?style=flat&label=) |
...
| [my-sync](https://github.com/2over/my-sync) | 锁、条件变量等同步原语 | ![stars](https://img.shields.io/github/stars/2over/my-sync?style=flat&label=) |
| [my-three-color](https://github.com/2over/my-three-color) | 三色标记等并发 / GC  | ![stars](https://img.shields.io/github/stars/2over/my-three-color?style=flat&label=) |
